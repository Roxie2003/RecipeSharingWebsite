<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="bookmarks.aspx.cs" Inherits="RecipeSharing.bookmarks" %>
...
<body align="center">
        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="myNavbar">
                <ul class="nav navbar-nav">
                    ...
                    <li class="active"><a href="bookmarks.aspx">Bookmarks</a></li>
                </ul>
    ...
    <div class="container-fluid bg-3 text-center" style="margin:10px 30px;padding:0px 50px;">
        <h1><b><u>My Bookmarks</u></b></h1><br />
    <form id="form1" runat="server">
         <div class="row" style="color:black;" runat="server" id="bookmark"></div>
    </form>
    </div>

    <div>
        <form>
            <button formaction="createRecipe.aspx" class="btn btn-primary" style="position: fixed; bottom: 20px; left:1420px; margin-left: -104.5px; border-radius: 50%;"><i style="font-size:30px" class="fa fa-plus fa-6" aria-hidden="true"></i></button>
        </form>
    </div><br><br><br>
